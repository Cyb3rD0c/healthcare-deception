...
// Check if timezone is set and valid, otherwise use a default value
$timezone = !empty($global_permission->timezone) ? $global_permission->timezone : 'UTC';
try {
...
$date = new DateTime();
$date->setTimezone($timezoneObject);
...
function genRandomString($length) {
    $characters = "QWERTYUIOPASDFGHJKLZXCVBNMQWERTYUIOPASDFGHJKLZXCVBNMQWERTYUIOPASDFGHJKLZXCVBNMQWERTYUIOPASDFGHJKLZXCVBNMQWERTYUIOPASDFGHJKLZXCVBNM";
    $string = "";    
    for ($p = 0; $p < $length; $p++) {
