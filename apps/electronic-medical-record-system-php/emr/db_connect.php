<?php
 ...
 $db = new mysqli("emr-db","root","yourpassword");
			...
			$table9="CREATE TABLE IF NOT EXISTS tbl_userlogs (id int(11) NOT NULL auto_increment,
		       ...
		       $table3="CREATE TABLE IF NOT EXISTS tbl_transactions (id int(11) NOT NULL auto_increment,
                   ...
                   $rowcount=mysqli_num_rows($result);
                       ...
                       if($rowcount==0)
                         {
                           $enter="INSERT INTO tbl_users (Password,Email,Firstname,Sirname,Mtitle,Phone,Role,State, Pic_name) VALUES('1234554321','mvumapatrick@gmail.com','Patrick','Mvuma','Mr','0999107724','Medical Doctor','Super', 'default_pic.jpg')";
                                  $db->query($enter);
                            $enter="INSERT INTO tbl_users (Password,Email,Firstname,Sirname,Mtitle,Phone,Role, Pic_name) VALUES('12345','hmanganda@gmail.com','Hendry','Manganda','Dr','0888876600','Clinician', 'default_pic.jpg')";
                                  $db->query($enter);  
