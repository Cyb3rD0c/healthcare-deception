...
$stableZ = "CREATE TABLE IF NOT EXISTS Excelfiles (
    id int(11) NOT NULL auto_increment,
...
if ($rowcount == 0) {
    ...
    $querydy = "INSERT INTO Excelfiles (ids, PaymentP, name, type, Size) VALUES ('1', 'Administrator.php', 'teachers.csv', 'application/vnd.ms-excel', '76')";
    $db->query($querydy) or die('Errorr, query failed to upload');

    $queryd = "INSERT INTO Excelfiles (ids, PaymentP, name, type, Size) VALUES ('1', 'Administrator.php', 'students.csv', 'application/vnd.ms-excel', '76')";
